...
function Fxsample() {
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: for suspended
	useEffect(() => {
	...
	return (
		<>
			<div
				...
				aria-describedby="click-to-play-description"
				aria-labelledby="click-to-play-title"
				aria-controls="click-to-play-content"
