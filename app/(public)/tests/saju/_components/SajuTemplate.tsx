...
function SajuTemplate() {
	...
	return (
		<div className="flex flex-col items-center">
			...
			{isPendingSaju && (
				<div className="animate-pulse text-red-500">Saju Loading...</div>
			)}
			...
			{isPendingImage && (
				<div className="animate-pulse text-red-500">ImageLoading...</div>
			)}
			{imageUrl && (
				<div className="relative h-1/2 min-h-[512px] w-1/2 overflow-hidden">
					<Image
			...
			<div className="w-[70%] text-gray-500 text-sm">
				{/** 소요시간 초로 변환할것 */}
				<p className="animate-bounce font-bold text-red-500">
