            ...
            <div className={styles.diarymid}>
              ...
              <div className={styles.notebox}>
                <div className={`${styles.notefull} ${uhbeeyul.className}`}>
                  ...
                  <p>
                    <span className={styles.diaryfont}>신식 태극당에서 수줍게 인사드렸었는데.</span>
                  </p>
                  <p>
                    <span className={styles.diaryfont}>저는 선생님 처음 만난 날이</span>
                  </p>
                  <p>
                    <span className={styles.diaryfont}>영화의 한 장면 같았어요.</span>
                  </p>
                  <p>
                    <span className={styles.diaryfont}>다른 날들보다 유독 따뜻했던</span>
                  </p>
                  <p>
                    <span className={styles.diaryfont}>날이었던 것 같아요.</span>
                  </p>
                  <p>
                    <span className={styles.diaryfont}>잠시 가을의 추위가 멈추던.</span>
                  </p>
                  <p>
                    <span className={styles.diaryfont}>긴장을 참 많이 했는데</span>
                  </p>
                  <p>
                    <span className={styles.diaryfont}>선생님은 화면에서처럼 멋지셨고</span>
                  </p>
                  <p>
                    <span className={styles.diaryfont}>저는 이게 꿈인가 싶었던 것 같아요.</span>
                  </p>
                  <p>&nbsp;</p>
                  <p>&nbsp;</p>
                  <p>&nbsp;</p>
