...
function ViewerTemplate() {
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: for
	useEffect(() => {
	...
	return (
		<div className={styles.guiMain3d} ref={guiMainRef}>
			...
			<div
				...
				aria-describedby="mouse-down-description"
				aria-labelledby="mouse-down-title"
				aria-controls="mouse-down-content"
				onKeyDown={(e) => {
					if (e.key === "Enter")
			...
			>
				<div className={styles.top3d}>
					...
					<Link href="/tests">
						<MdClear className="xyzright pointer-events-auto h-6 w-6 cursor-pointer select-all" />
					</Link>
				</div>
				...
				<div className={styles.btm3d}>
					...
					<div className={styles.btmRight3d}>
						<Md360
							className="xyzright h-6 w-6 cursor-pointer"
							data-ui="360"
						...
						/>
						<MdGridOn
							className="xyzview h-6 w-6 cursor-pointer"
							data-ui="grid_on"
							onClick={handleLightClick}
						/>
						<MdContrast
						...
						/>
						<MdGridView
							className="xyzeffects h-6 w-6 cursor-pointer"
							data-ui="grid_view"
							onClick={handleLightClick}
						/>
						<MdGraphicEq
