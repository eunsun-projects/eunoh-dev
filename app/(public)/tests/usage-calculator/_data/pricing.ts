import { MODELS_WITHOUT_IMAGE } from "../_libs/zustand";

// per 1M tokens
const pricing = {
  txt_model: [
    {
      model: MODELS_WITHOUT_IMAGE.GPT_4O,
      input_base: 2.5,
      output_base: 10,
    ...
    {
      model: MODELS_WITHOUT_IMAGE.GPT_4O_MINI,
      input_base: 0.15,
      output_base: 0.6,
