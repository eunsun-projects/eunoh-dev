          ...
          <div className="flex flex-col gap-2 w-full">
            ...
            <div className="flex flex-col gap-2 text-xs">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="text-neutral-900 dark:text-neutral-50">{'css'}</span>
                <span>{'- 반응형, 키프레임, 다양한 선택자에 익숙합니다.'}</span>
              </div>
              <div className="flex items-center gap-1">
                <FaJs className="text-neutral-900 dark:text-neutral-50 text-lg" />
                <span className="text-neutral-900 dark:text-neutral-50">{'js'}</span>
                <span>{'- 비동기, ES6+, web api 사용에 익숙합니다.'}</span>
              </div>
              <div className="flex items-center gap-1">
                <BiLogoTypescript className="text-neutral-900 dark:text-neutral-50 text-lg" />
                <span className="text-neutral-900 dark:text-neutral-50">{'ts'}</span>
                <span>{'- 제네릭, 유틸리티 타입 등을 활용하여 안전한 코드를 작성합니다.'}</span>
              </div>
              <div className="flex items-center gap-1">
                <RiTailwindCssFill className="text-neutral-900 dark:text-neutral-50 text-base" />
                <span className="text-neutral-900 dark:text-neutral-50">{'tailwind'}</span>
                <span>{'- 유틸리티 클래스 커스터마이징에 익숙합니다.'}</span>
              </div>
              <div className="flex items-center gap-1">
                <FaSass className="text-neutral-900 dark:text-neutral-50 text-lg" />
                <span className="text-neutral-900 dark:text-neutral-50">{'sass'}</span>
                <span>{'- 변수, 중첩, 믹스인을 활용하여 까다로운 UI를 구현합니다.'}</span>
              </div>
              <div className="flex items-center gap-1">
                <SiStyledcomponents className="text-neutral-900 dark:text-neutral-50 text-lg" />
                <span className="text-neutral-900 dark:text-neutral-50">{'styled-components'}</span>
                <span>{'- 필요한 경우 동적 스타일링을 위해 사용합니다.'}</span>
              </div>
              <div className="flex items-center gap-1">
                <FaReact className="text-neutral-900 dark:text-neutral-50 text-lg" />
                <span className="text-neutral-900 dark:text-neutral-50">{'react'}</span>
                <span>{'- react 19 스터디 중 입니다.'}</span>
              </div>
              <div className="flex items-center gap-1">
                <SiSvelte className="text-neutral-900 dark:text-neutral-50 text-lg" />
                <span className="text-neutral-900 dark:text-neutral-50">{'svelte'}</span>
                <span>{'- svelte-kit 을 사용한 프로젝트 경험이 있습니다.'}</span>
              </div>
              <div className="flex items-center gap-1">
                <RiNextjsFill className="text-neutral-900 dark:text-neutral-50 text-lg" />
                <span className="text-neutral-900 dark:text-neutral-50">{'next'}</span>
                <span>{'- SSG, ISR, SSR, CSR 을 최적화하여 사용할 수 있습니다.'}</span>
              </div>
              <div className="flex items-center gap-1 ">
                <RiVuejsFill className="text-neutral-900 dark:text-neutral-50 text-lg" />
                <span className="text-neutral-900 dark:text-neutral-50">{'vue'}</span>
                <span>{'- vue3 를 사용한 프로젝트 경험이 있습니다.'}</span>
              </div>
              <div className="flex items-center gap-1">
                <SiReactquery className="text-neutral-900 dark:text-neutral-50 text-lg" />
                <span className="text-neutral-900 dark:text-neutral-50">{'react-query'}</span>
                <span>{'- prefetch, infinite, optimistic 등을 자유롭게 사용합니다.'}</span>
              </div>
              <div className="flex items-center gap-1">
                <TbBrandRedux className="text-neutral-900 dark:text-neutral-50 text-lg" />
                <span className="text-neutral-900 dark:text-neutral-50">{'redux'}</span>
                <span>{'- RTK, thunk, saga 등을 활용하여 상태 관리를 할 수 있습니다.'}</span>
              </div>
              <div className="flex items-center gap-1">
                <Zustand className="text-neutral-900 dark:text-neutral-50 w-4 h-4" />
                <span className="text-neutral-900 dark:text-neutral-50">{'zustand'}</span>
                <span>{'- 가볍고 쉽게 전역상태관리를 수행합니다.'}</span>
              </div>
              <div className="flex items-center gap-1">
                <SiReacthookform className="text-neutral-900 dark:text-neutral-50 text-base" />
                <span className="text-neutral-900 dark:text-neutral-50">{'react-hook-form'}</span>
                <span>{'- form 관리를 효율적으로 할 수 있습니다.'}</span>
              </div>
              <div className="flex items-center gap-1">
                <PiFramerLogoFill className="text-neutral-900 dark:text-neutral-50 text-base" />
                <span className="text-neutral-900 dark:text-neutral-50">{'framer-motion'}</span>
                <span>{'- 복잡한 애니메이션을 손쉽게 구현합니다.'}</span>
              </div>
              <div className="flex items-center gap-1">
                <SiTurborepo className="text-neutral-900 dark:text-neutral-50 text-base" />
                <span className="text-neutral-900 dark:text-neutral-50">{'turborepo'}</span>
                <span>{'- 모노레포 프로젝트를 효율적으로 관리할 수 있습니다.'}</span>
              </div>
              <div className="flex items-center gap-1">
                <TbBrandThreejs className="text-neutral-900 dark:text-neutral-50 text-base" />
                <span className="text-neutral-900 dark:text-neutral-50">{'three.js'}</span>
                <span>{'- 웹에서 3D 환경을 구현할 수 있습니다.'}</span>
              </div>
              <div className="flex items-center gap-1">
                <IoLogoFirebase className="text-neutral-900 dark:text-neutral-50 text-base" />
                <span className="text-neutral-900 dark:text-neutral-50">{'firebase'}</span>
                <span>{'- firestore, auth, storage, realtime 에 익숙합니다.'}</span>
              </div>
              <div className="flex items-center gap-1">
                <RiSupabaseFill className="text-neutral-900 dark:text-neutral-50 text-lg" />
                <span className="text-neutral-900 dark:text-neutral-50">{'supabase'}</span>
                <span>{'- postgres, realtime, auth, storage 에 익숙합니다.'}</span>
              </div>
              <div className="flex items-center gap-1">
                <SiGraphql className="text-neutral-900 dark:text-neutral-50 text-lg" />
                <span className="text-neutral-900 dark:text-neutral-50">{'graphql'}</span>
