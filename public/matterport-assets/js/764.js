  ...
  [764],
  {
    ...
    48764: (t, r, e) => {
      ...
      function h(t, r, e) {
        ...
        if (F(t, ArrayBuffer) || (t && F(t.buffer, ArrayBuffer))) return l(t, r, e);
        if (
        ...
        var o = (function (t) {
          ...
          if (void 0 !== t.length) return 'number' != typeof t.length || Y(t.length) ? u(0) : c(t);
      ...
      (s.TYPED_ARRAY_SUPPORT = (function () {
        ...
        (s.compare = function (t, r) {
          if (
            ...
            F(r, Uint8Array) && (r = s.from(r, r.offset, r.byteLength)),
        ...
        (s.prototype.compare = function (t, r, e, n, o) {
          if ((F(t, Uint8Array) && (t = s.from(t, t.offset, t.byteLength)), !s.isBuffer(t)))
            throw new TypeError(
      ...
      function P(t, r, e, n, i) {
        return (r = +r), (e >>>= 0), i || k(t, 0, e, 4), o.write(t, r, e, n, 23, 4), e + 4;
      }
      function j(t, r, e, n, i) {
        return (r = +r), (e >>>= 0), i || k(t, 0, e, 8), o.write(t, r, e, n, 52, 8), e + 8;
      }
      (s.prototype.slice = function (t, r) {
        ...
        (s.prototype.writeUintLE = s.prototype.writeUIntLE =
          function (t, r, e, n) {
            ((t = +t), (r >>>= 0), (e >>>= 0), n) || x(this, t, r, e, Math.pow(2, 8 * e) - 1, 0);
            var o = 1,
              i = 0;
    ...
    80645: (t, r) => {
      (r.read = function (t, r, e, n, o) {
        var i,
          ...
          l = t[r + p];
        for (
          p += c, i = l & ((1 << -a) - 1), l >>= -a, a += u;
          a > 0;
          i = 256 * i + t[r + p], p += c, a -= 8
        );
        for (
          f = i & ((1 << -a) - 1), i >>= -a, a += n;
          a > 0;
            ...
            r = Math.abs(r),
              isNaN(r) || r === 1 / 0
                ...
                : ((f = Math.floor(Math.log(r) / Math.LN2)),
                  ...
                  (r += f + p >= 1 ? c / s : c * Math.pow(2, 1 - p)) * s >= 2 && (f++, (s /= 2)),
                  f + p >= a
                    ? ((u = 0), (f = a))
                    : f + p >= 1
